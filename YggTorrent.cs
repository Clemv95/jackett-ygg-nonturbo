...
namespace Jackett.Common.Indexers.Definitions
{
    ...
    public class YggTorrent : IndexerBase
    {
        ...
        private bool GetRemoveYearTitleEnabled()
        {
            _removeYearTitle ??= ((BoolConfigurationItem)configData.GetDynamic(CfgRemoveYearTitle)).Value;
            return _removeYearTitle.Value;
        }
        ...
        private IEnumerable<ReleaseInfo> ParseSearchResults(string html)
        {
            ...
            try
            {
                ...
                foreach (var row in rows)
                {
                    ...
                    var details = new Uri(detailsHref.TrimStart('/'));
                    var link = new Uri(
